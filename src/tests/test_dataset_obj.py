...
class TestCreateDataSetObject(unittest.TestCase):
    ...
    def test_MAL_MSA_01_label(self):
        data = (
            self.mal_train
            if "MAL_MSA_01" in self.mal_train["file_name"]
            else self.mal_dev
        )
    ...
    def test_MAL_MSA_23_label(self):
        data = (
            self.mal_train
            if "MAL_MSA_23" in self.mal_train["file_name"]
            else self.mal_dev
        )
    ...
    def test_TAM_MSA_01_label(self):
        data = (
            self.tam_train
            if "TAM_MSA_01" in self.tam_train["file_name"]
            else self.tam_dev
        )
    ...
    def test_TAM_MSA_23_label(self):
        data = (
            self.tam_train
            if "TAM_MSA_23" in self.tam_train["file_name"]
            else self.tam_dev
        )
