...
class StochasticGradientDescentClassifier(Classifier):
    def __init__(self, config: dict, ds_dict: datasets.DatasetDict) -> None:
        ...
        Initializes a Stochastic Gradient Descent Classifier Model
        """
    ...
    def train_predict(
        ...
        This method trains the Stochastic Gradient Descent Classifier using the given train data, and also predicts the labels
